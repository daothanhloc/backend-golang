...
func TestTransferTx(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		fmt.Print("tx", fromAccount.Balance, toAccount.Balance)
	...
	// account1's balance should be decreased by amount * n
	// account2's balance should be increased by amount * n
